...
class GameEngine {
    constructor() {
        this.mapGenerator = new mapGenerator_1.MapGenerator();
    }
    initializeGame(room) {
    ...
    validateMove(room, playerId, action) {
        if (!room.map) {
    ...
    executeMove(room, playerId, action) {
